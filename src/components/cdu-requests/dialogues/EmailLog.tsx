...
import { useGetEmailLogQuery } from "services/cdu-requests.service";
...
const EmailLog = ({ closeHandle, open, userCode }: IProps) => {
  ...
  const previousResult = useGetEmailLogQuery(
    {
      page_no: page - 1,
  ...
  const currentResult = useGetEmailLogQuery(
    {
      page_no: page,
      no_of_records: perPage,
      ...filters,
  ...
  const nextResult = useGetEmailLogQuery(
    {
      page_no: page + 1,
      no_of_records: perPage,
      ...filters,
        ...
        >
          ...
          <DialogContent>
            ...
            >
              ...
              >
                <Typography variant="h5">Email Log {userCode}</Typography>
                <IconButton
                  onClick={() => {
