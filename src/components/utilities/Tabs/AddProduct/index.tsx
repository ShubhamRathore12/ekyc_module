...
const AddProduct = () => {
  ...
  return (
    <>
      <UtlitiesLayout>
        <TabHeader
          leftText="Add or Modify Product"
          rightButton1="Create New Product"
