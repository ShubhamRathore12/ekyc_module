...
import { useAccountBrokerageMutation } from "services/accountopen.service";
import * as Yup from "yup";

const BrokerageSchemeFormElements = () => {
  ...
  const [accountBrokerage] = useAccountBrokerageMutation();
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      ...
      commodity_min: Yup.number().required("Commodity Min is required"),
      ...
      // product_code : Yup.string().required("Prodiuct Code is required"),
    ...
    onSubmit: async (values, helpers) => {
      ...
      try {
        const res = await accountBrokerage(values).unwrap();
         ...
         onChange={(e) => {
          ...
          formik.setFieldValue('chargeable_for_account_opening', value);
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <TextField
                name="delivery_min"
                placeholder="Enter Delivery min"
          ...
          >
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <TextField
                name="derivative_max"
                placeholder="Enter Derivative max"
                ...
                helperText={(formik.touched.derivative_max && formik.errors.derivative_max) || " "}
                onBlur={formik.handleBlur}
              ></TextField>
            </Box>
            <Box sx={{ flex: 1 }}>
          ...
          >
            <Box sx={{ flex: 1 }}>
              ...
              <TextField
                ...
                helperText={(formik.touched.commodity_perc && formik.errors.commodity_perc) || " "}
                onBlur={formik.handleBlur}
              ></TextField>
            </Box>
            <Box sx={{ flex: 1 }}>
              ...
              <TextField
                name="commodity_min"
                placeholder="Enter Commodity Min"
          ...
          >
            <Box sx={{ flex: 1 }}>
              ...
              <TextField
                ...
                error={Boolean(formik.touched.commodity_opt_min && formik.errors.commodity_opt_min)}
                type="number"
                onChange={(e) => {
                  const value = e.target.value;
                  if (/^\d*\.?\d{0,3}$/.test(value)) {
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <TextField
                ...
                error={Boolean(formik.touched.commodity_opt_max && formik.errors.commodity_opt_max)}
                type="number"
                onChange={(e) => {
                  const value = e.target.value;
                  if (/^\d*\.?\d{0,3}$/.test(value)) {
...
export default BrokerageSchemeFormElements;
